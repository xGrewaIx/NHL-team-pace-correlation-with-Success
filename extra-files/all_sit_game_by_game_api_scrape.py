...
def get_shot_data(game_data):
    ...
    for play in plays:
        ...
        if typeDescKey in ['shot-on-goal', 'missed-shot', 'blocked-shot', 'goal']:
...
def main():
    ...
    shot_data.to_csv('stage1and2-gatherAndCleanData/nhlAPI/allSit_nhl_shot_data.csv', index=False)
    faceoff_data.to_csv('stage1and2-gatherAndCleanData/nhlAPI/allSit_nhl_faceoff_data.csv', index=False)
    season_averages.to_csv('stage1and2-gatherAndCleanData/nhlAPI/allSit_nhl_season_averages.csv', index=False)
